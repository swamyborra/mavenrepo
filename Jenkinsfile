...
stage('deploy'){
steps{
deploy adapters: [tomcat7(credentialsId: 'eb0c8b8b-4c50-4d25-8835-4a28313d7cd1', path: '', url: 'http://3.110.224.182:8080/manager/html')], contextPath: 'studentapp', war: '**/*.war'
}
}
}
} //pipeline closed
